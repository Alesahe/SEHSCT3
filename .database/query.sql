...
INSERT INTO pages(aboutMeText, openingHoursText, ratioText, resumeText, welcomePageText) VALUES (
    ...
    "A a registered family day care educator, we strictly adhere to the Education and Care Services National Law and Regulations. This includes maintaining one educator for four preschool-aged children and three school-aged children.",
    "I hold the Diploma in Early Childhood Education and Care, and am a registered family day care educator through the Approved Service Baulkham Hills Family Day Care. <br><br> I also have experience working at multiple Early Learning Centres and speak both English and Mandarin.",
